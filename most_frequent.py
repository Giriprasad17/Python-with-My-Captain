#python program to get the frequency of characters in a string in descending order of frequency
#Input the string
...
lis.sort(key=tf,reverse = True)                 #sort the letters in ascending order
